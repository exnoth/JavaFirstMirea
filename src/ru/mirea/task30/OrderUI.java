...
public class OrderUI extends JFrame implements Serializable
{
    ...
    public static void main(String[] args) throws OrderAlreadyException, IOException {
        ...
        FileOutputStream output = new FileOutputStream("C:\\Users\\алина\\IdeaProjects\\JavaFirstMireayy\\src\\ru\\mirea\\task30\\save.ser");
        ObjectOutputStream obj = new ObjectOutputStream(output);

        obj.writeObject(orderManager1);
